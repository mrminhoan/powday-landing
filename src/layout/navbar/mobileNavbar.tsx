...
const MobileNavbar: React.FC = (props: any) => {
  ...
  return (
    <div className="relative z-50">
      ...
      <div
        className={clsx(
          "fixed top-0 right-0 h-full w-4/5 bg-white shadow-lg transform transition-transform duration-300 overflow-y-auto",
                  ...
                  >
                    {item.children.map((child) => (
                      <a
                        key={child.title}
                        href={child.href}
                        className="flex items-center gap-2 text-sm text-gray-700 hover:text-black font-semibold"
                      >
                  ...
                  >
                    {item.groups.map((group) => (
                      <div key={group.title} className="pl-4 mb-2">
                        <div className="text-xs font-bold text-gray-500 uppercase mt-2 mb-1">
                          {group.title}
                        </div>
